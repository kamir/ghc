...
public final class QGisHadoopConnector extends JFrame {
    ...
    private void initComponents() {
        ...
        edgesStatic1 = new javax.swing.JTextField();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jPanel1.border.title"))); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jButton4, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jButton4.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel5, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jLabel5.text")); // NOI18N

        jTextField1.setForeground(new java.awt.Color(255, 153, 0));
        jTextField1.setText(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jTextField1.text")); // NOI18N
        ...
        jTextField2.setText(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jTextField2.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel6, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jLabel6.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jButton5, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jButton5.text")); // NOI18N
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jPanel8.border.title"))); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel4, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jLabel4.text")); // NOI18N

        edgesStatic.setText(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.edgesStatic.text")); // NOI18N
        edgesStatic.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jLabel3.text")); // NOI18N

        nodes.setText(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.nodes.text")); // NOI18N
        ...
        jtaQuery.setRows(5);
        jtaQuery.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jtaQuery.border.title"))); // NOI18N
        jScrollPane1.setViewportView(jtaQuery);

        jtaResponse.setColumns(20);
        jtaResponse.setRows(5);
        jtaResponse.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jtaResponse.border.title"))); // NOI18N
        jScrollPane2.setViewportView(jtaResponse);

        org.openide.awt.Mnemonics.setLocalizedText(jLabel8, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jLabel8.text")); // NOI18N

        edgesStatic1.setText(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.edgesStatic1.text")); // NOI18N
        edgesStatic1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addGap(4, 4, 4))
                    .addComponent(edgesStatic1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jcbAppend, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jcbAppend.text")); // NOI18N

        jtaNTMNListe.setColumns(20);
        jtaNTMNListe.setRows(5);
        jScrollPane3.setViewportView(jtaNTMNListe);

        org.openide.awt.Mnemonics.setLocalizedText(jButton8, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jButton8.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel7, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jLabel7.text")); // NOI18N

        jPanel9.setLayout(new java.awt.BorderLayout());

        jScrollPane5.setPreferredSize(new java.awt.Dimension(444, 220));

        jtaLogPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jtaLogPanel.border.title"))); // NOI18N
        jScrollPane5.setViewportView(jtaLogPanel);

        jPanel10.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jPanel10.border.title"))); // NOI18N

        jTextField6.setText(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jTextField6.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel9, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jLabel9.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel10, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jLabel10.text")); // NOI18N

        jTextField4.setText(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jTextField4.text")); // NOI18N

        jTextField5.setText(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jTextField5.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jButton9, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jButton9.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jButton7, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jButton7.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel11, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jLabel11.text")); // NOI18N
        ...
        jTabbedPane1.addTab(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jPanel7.TabConstraints.tabTitle"), jPanel7); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jButton2, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jButton2.text")); // NOI18N
        ...
        jTabbedPane1.addTab(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jPanel6.TabConstraints.tabTitle"), jPanel6); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jButton1, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jButton1.text")); // NOI18N
        ...
        jTabbedPane1.addTab(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jPanel3.TabConstraints.tabTitle"), jPanel3); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jButton3, org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jButton3.text")); // NOI18N
        ...
        jTabbedPane1.addTab(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jPanel4.TabConstraints.tabTitle"), jPanel4); // NOI18N
        ...
        jTabbedPane1.addTab(org.openide.util.NbBundle.getMessage(QGisHadoopConnector.class, "QGisHadoopConnector.jPanel5.TabConstraints.tabTitle"), jPanel5); // NOI18N
...
// TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (appendAsNewTimeRange) {
            ...
            ImpalaDynamicImportConnector.currentPartitionId = 0;
...
//Export full graph
        ...
        if( jcbAppend.isSelected() ) filename = path3 + "_part_XYZ_" + path4;
    ...
    private javax.swing.JTextField edgesStatic1;
    ...
    public static void main(String[] args) {
        QGisHadoopConnector view = new QGisHadoopConnector();
...
//        this.jlNodes.setText(""+graph.getNodeCount());        
    ...
    public static String loadNetworkLayersForTMN(String networkName, QGisHadoopConnector comp) {
    ...
    public static String[] loadQueriesForNetworkLayer(String networkName, String layerName, QGisHadoopConnector comp) {
...
//            }
    ...
    static public String loadTMNListeFromMetastore(QGisHadoopConnector comp) {
